...
def work_collect():
    ...
    # 주식 정보 리턴 (주식코드 / 주식명)
    m_dic = NaverStock.get_stock_list('kospi')
    ...
    for key, value in m_dic.items():
        ...
        es = ElasticData.ElasticSearchData()
        es.insert_stock_info(key, m_dic_detail)
    ...
    '''
    # 주식 정보 리턴 (주식코드 / 주식명)
    m_dic = NaverStock.get_stock_list('kosdaq')
